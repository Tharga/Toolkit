...
public class DurationExtensionsTest
{
    ...
    [InlineData(-1, EUnit.Second, "Just now")]
    [InlineData(1, EUnit.Second, "Soon")]
    [InlineData(-1000, EUnit.Minute, "A minute ago")]
    [InlineData(1000, EUnit.Minute, "Soon")]
    [InlineData(-60000, EUnit.Hour, "This hour")]
    [InlineData(60000, EUnit.Hour, "Later today")]
    [InlineData(-3600000, EUnit.Day, "Today")]
    [InlineData(3600000, EUnit.Day, "Tomorrow")]
    [InlineData(-86400000, EUnit.Week, "This week")]
    [InlineData(86400000, EUnit.Week, "This week")]
